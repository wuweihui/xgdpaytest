...
class PosTradeMSG(Pos3MsgBase):
   ...
   fields[3] = ['3', 'verion', 'N', 'BCD', '2', True, False, '0x30 0x01']
   ...
   fields[7] = ['7', 'tradeSeq', 'N', 'BCD', '3', True, True, '中心根据判断程序版本是否大于“\x31\x02”（包含\x31\x02）来确定是否有“7.交易批次号”和“8.预留”两项，']
   fields[8] = ['8', 'tradeReserved', 'AN', 'BCD', '20', True, True, '中心根据判断程序版本是否大于“\x31\x02”（包含\x31\x02）来确定是否有“7.交易批次号”和“8.预留”两项，']
   fields[9] = ['9', 'tradeSerial', 'N', 'BCD', '3', True, True, '当MAC值不为“0X00”时，终端应检查应答与请求是否一致']
...
if __name__ == '__main__':
   ...
   msg = '006b60000300008708bc0f5a0138343934343033353331313630333138303031343039390000003020130184003e0200310400050062ffffff0000000000000000000000000000000000000000316154303034028f8d000c0b3161530c9529f29e93d0d56a0dcfe038aa7592b2'
   #msg = ''
